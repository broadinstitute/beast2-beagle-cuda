...
# This script is intended to invoke beast2 within a Docker container
...
beast -beagle_GPU -beagle_double -beagle_scaling always -beagle_order ${BEAGLE_ORDER} ${BEAST_EXTRA_ARGS} ${INPUT_FILE} >> "${OUTPUT_PREFIX}.out"
ls 
